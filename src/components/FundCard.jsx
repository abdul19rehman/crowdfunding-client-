...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  // if(daysLeft==-30){
    return (
      ...
      <div>
      <div className="sm:w-[288px] w-full rounded-[0px] bg-[#800080] cursor-pointer" onClick={handleClick}>
      <img src={image} alt="fund" className="w-full h-[158px] object-cover rounded-[0px]"/>
      ...
      <div className="flex flex-col p-4">
        ...
        {/* {/<h2>
          You have {remainingDays} cars in your garage.
        </h2> } */}
        </div>
      }
      </>
